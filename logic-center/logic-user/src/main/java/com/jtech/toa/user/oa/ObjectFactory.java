 ...
 * generated in the com.jtech.toa.security package. 
...
public class ObjectFactory {
    ...
    private final static QName _CheckLogin_QNAME = new QName("http://oaws.absen.com/", "checkLogin");
    private final static QName _CheckLoginResponse_QNAME = new QName("http://oaws.absen.com/", "checkLoginResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.jtech.toa.security
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://oaws.absen.com/", name = "checkLogin")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://oaws.absen.com/", name = "checkLoginResponse")
