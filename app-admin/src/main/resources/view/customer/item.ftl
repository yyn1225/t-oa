            ...
            <div class="widget-body no-padding ">
                <form class="smart-form" id="customer-form">
                    ...
                    <fieldset>
                        ...
                        <label class="col col-3 input">
                            <input type="text" name="ownership" class="form-control" value="${(customer.ownership)!}">
                        </label>
                        <label class="col col-1 text-align-right padding">
                    ...
                    <fieldset>
                        ...
                        <label class="col col-5 input">
                            <input type="hidden" name="billing" class="form-control"
                    ...
                    <fieldset style="height: 80px;">
                        ...
                        <label class="col col-md-11 input">
                            ...
                            padding-right: 3px;" rows="4" name="description">${(customer.description)!}</textarea>
                        </label>
                    </fieldset>
