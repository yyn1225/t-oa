    ...
    <fieldset>
        ...
        <label class="col col-10 input">
            <select class="select2" name="auto" id="auto">
                <option value="0" <#if standard.standard??&&standard.standard==0>selected="selected"</#if>
                        data-dic="select.option.no">
                </option>
                <option value="1" <#if standard.standard??&&standard.standard==1>selected="selected"</#if>
        ...
        <#list years as item>
            <div class="tab-pane fade in <#if item_index==0>active</#if>" id="s${item_index}">
                ...
                <fieldset>
                    ...
                    <label class="col col-10 input">
                        <input class="unit-type" name="unitType" style="width: 100%;"
                               id="unit_${(item_index)}"
