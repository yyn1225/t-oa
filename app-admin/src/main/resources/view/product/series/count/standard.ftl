...
<div class="jarviswidget" data-widget-colorbutton="false" data-widget-editbutton="false"
    ...
    <header>
        ...
        <a class="btn btn-primary btn-xs s-add" style="float: right" data-standard-id="0">
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        var editHtml = '<a class="btn btn-xs btn-primary edit" ' +
                                ...
                                'data-id="' + row.sid + '"' +
                                'data-standard-id="' + data + '">' +
                                message['product.series.maintain'] + '</a>';
...
//                },
    ...
    $('#spare-choose').click(function () {
        ...
        var type = $(a).data("standard-id");
        $.ajax({
            url: '/api/series/count/save',
            type: 'POST',
            data: {seriesId: seriesId, standardIds: newtr.join(','), type: type},
            success: function (data) {
