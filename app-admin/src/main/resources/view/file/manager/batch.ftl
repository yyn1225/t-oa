<#compress>
<span id="file_edit_id"  hidden>${ids}</span>
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 right" style="margin-top: 20px;">
        <div class="btn-group">
            <button type="button" class="file-type btn btn-default"  data-type="1">
                <dic data-dic="file.list.security.NewsAndActivities">新闻&活动</dic>
            </button>
            <button type="button" class="file-type btn btn-default"   data-type="2">
                <dic data-dic="file.list.security.Product">产品</dic>
            </button>
            <button type="button" class="file-type btn btn-default " data-type="3">
                <dic data-dic="file.list.security.Solution">案例</dic>
            </button>
            <button type="button" class="file-type btn btn-default  "data-type="4">
                <dic data-dic="file.list.security.Brand">品牌</dic>
            </button>
            <div class="btn-group" style="float: right;width: 27%;">
                <button type="button" class="see-type btn btn-default btnSM"  data-type="1">
...
<script type="text/javascript">
    url.fileUpdateAllUrl = '/api/file/updateAll';
