...
public class UploadImgController {
     ...
     */
    @PostMapping("/image")
    public ExperienceImage file(@RequestUser RequestSubject user,@RequestPart("file") MultipartFile file) {
        if (file == null) {
...
//            }
            ...
            return experienceService.saveFileOverrid(saveFile, uploadFileName, user.getId());
        } catch (IOException e) {
