...
<div class="widget-body">
    <fieldset class="new-fieldset">
        <input type="hidden" id="approvalId" value="${(approvalId?c)!}">
        <input type="hidden" id="examine-state" value="${(state)!}">
        <label class="col col-2 text-align-right padding">
            <dic data-dic="customer.item.name"></dic>:
        </label>
        <label class="col col-10 input padding7">
            ${(offer.customerName)!}
        </label>
    </fieldset>
    ...
    <fieldset class="new-fieldset">
        ...
        <label class="col col-4 input padding7">
            ${(offer.levelName)!}
        </label>
        <label class="col col-2 text-align-right padding">
    ...
    <fieldset class="new-fieldset">
        ...
        <label class="col col-10 textarea">
            <textarea rows="3" class="custom-scroll" id="opinion">
            </textarea>
        </label>
    </fieldset>
</div>
