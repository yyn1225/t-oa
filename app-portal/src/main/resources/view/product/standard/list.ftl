        ...
        standardTable.init({
            ...
            dataTable : {
                ...
                columns   : [
                    ...
                    {data: "type", title: message["product.spare.list.type"], width: '140px'},
                    {data: "brand", title: message["product.spare.list.brand"],width: '140px'},
                    {data: "unit", title: message["product.spare.list.unit"], width: '100px'},
